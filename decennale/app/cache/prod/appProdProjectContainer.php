...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'decennale', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Abi/RoutineBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Infojet/DevisBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Abi/UtilisateurBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Abi\\RoutineBundle\\Entity');
        $c->addDriver($b, 'Infojet\\DevisBundle\\Entity');
        $c->addDriver($b, 'Abi\\UtilisateurBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AbiRoutineBundle' => 'Abi\\RoutineBundle\\Entity', 'InfojetDevisBundle' => 'Infojet\\DevisBundle\\Entity', 'AbiUtilisateurBundle' => 'Abi\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_71c4c4d1cd60f301f9b1fc1dc55d6c62d13ef5b3bfabfbebd77a1ee240d9c0ef');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Abi\\UtilisateurBundle\\Entity\\Utilisateur' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'abi_utilisateur_logout'));
        ...
        $h->setOptions(array('login_path' => 'abi_utilisateur_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $i->setOptions(array('login_path' => 'abi_utilisateur_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => 'abi_utilisateur_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '59dfb4f55fa7f1.43145893', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'abi_utilisateur_login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'secured_area', $g, $h, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('commercial@devis-decennale.fr');
        $a->setPassword('Commercial93');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Abi/RoutineBundle/Resources/views'), 'AbiRoutine');
        $instance->addPath(($this->targetDirs[3].'/src/Infojet/DevisBundle/Resources/views'), 'InfojetDevis');
        $instance->addPath(($this->targetDirs[3].'/src/Abi/UtilisateurBundle/Resources/views'), 'AbiUtilisateur');
        $instance->addPath(($this->targetDirs[3].'/src/Admin/DecennaleBundle/Resources/views'), 'AdminDecennale');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('V5LyMQ3e9Ln9qgfHvyW3cdj988D946ED');
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'abi_utilisateur_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_GERANT' => array(0 => 'ROLE_CLIENT'), 'ROLE_ADMIN' => array(0 => 'ROLE_GERANT'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Abi\\UtilisateurBundle\\Entity\\Utilisateur', 'mail', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AbiRoutineBundle' => 'Abi\\RoutineBundle\\AbiRoutineBundle',
                'InfojetDevisBundle' => 'Infojet\\DevisBundle\\InfojetDevisBundle',
                'AbiUtilisateurBundle' => 'Abi\\UtilisateurBundle\\AbiUtilisateurBundle',
                'AdminDecennaleBundle' => 'Admin\\DecennaleBundle\\AdminDecennaleBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'decennale',
            'database_user' => 'root',
            ...
            'mailer_port' => 587,
            'mailer_user' => 'commercial@devis-decennale.fr',
            'mailer_password' => 'Commercial93',
            'locale' => 'en',
            ...
            'kernel.secret' => 'V5LyMQ3e9Ln9qgfHvyW3cdj988D946ED',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'commercial@devis-decennale.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Commercial93',
