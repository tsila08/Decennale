 ...
 */
class Departements extends \Abi\RoutineBundle\Entity\Departements implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\Departements' . "\0" . 'id', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\Departements' . "\0" . 'regionId', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\Departements' . "\0" . 'name', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\Departements' . "\0" . 'numero');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Departements $proxy) {
