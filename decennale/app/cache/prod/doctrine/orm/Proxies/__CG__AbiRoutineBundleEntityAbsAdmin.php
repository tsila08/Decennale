 ...
 */
class AbsAdmin extends \Abi\RoutineBundle\Entity\AbsAdmin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\AbsAdmin' . "\0" . 'id', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\AbsAdmin' . "\0" . 'login', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\AbsAdmin' . "\0" . 'password', '' . "\0" . 'Abi\\RoutineBundle\\Entity\\AbsAdmin' . "\0" . 'info');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbsAdmin $proxy) {
